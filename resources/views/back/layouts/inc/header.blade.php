    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
                <a href="layout-condensed4965.html?theme=dark" class="nav-link px-0 hide-theme-dark"
                ...
                <a href="layout-condensed6a08.html?theme=light" class="nav-link px-0 hide-theme-light"
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm"
                        style="background-image: url({{ asset('back/static/avatars/000m.jpg') }})"></span>
